...
void main() {
  testWidgets('Deve mostrar na main a imagem quando o dashboard está aberto', (WidgetTester tester) async {
    ...
    expect(mainImage, findsNWidgets(1)); // VERIFICA SE ACHOU ALGUM ELEMENTO E SE É O QUE EU QUERO VER
  });
  testWidgets('Deve mostrar a primeira feature quando o dashboard está aberto', (tester) async {
    ...
    expect(firstFeature, findsNWidgets(2)); // VERIFICA SE ACHOU ALGUM ELEMENTO E SE É O QUE EU QUERO VER
  });
}
